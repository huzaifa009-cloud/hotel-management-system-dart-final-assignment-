...
// void main() {
//   // 1. Greet the user by huzaifa with help of ai
...
// }
//restro management end here

//hotel management starts
...
void main() {
  print("Greetings");
  //room numbers
  List<int> rooms = [100, 101, 102];
  //false means room s avalable
  List<bool> isBooked = [false, false, false];
  bool isRunning = true;
  ...
  //userinput choice of user
  String userinput = stdin.readLineSync()!;
  if (userinput == "1") {
    print("-- ROOM STATUS ---");
    for (int i = 0; i < rooms.length; i++) {
      if (isBooked[i] == true) {
        print("room ${rooms[i]}:xxxxxx booked xxxx");
      } else {
        print("room ${rooms[i]}:---- Available -----");
      }
    }
  }
  //roombooking by user
    ...
    print("=========BOOK A ROOM");
    print("--ROOM100--,--ROOM101--,--ROOM102-- are AVAILABLE");
    print("------ENTER room number to book------");

    String inputRoom = stdin.readLineSync()!;
    if (inputRoom == "100") {
      if (isBooked[0] == true) {
        print("Sorry, Room 100 is already booked!");
      } else {
        isBooked[0] = true;
        print("Success! Room 100 is now booked for you.");
      }
    } else if (inputRoom == "101") {
      if (isBooked[1] == true) {
        print("Sorry, Room 101 is already booked!");
      } else {
        isBooked[1] = true;
        print("Success! Room 101 is now booked for you.");
      }
    } else if (inputRoom == "102") {
      if (isBooked[2] == true) {
        print("Sorry, Room 102 is already booked!");
      } else {
        isBooked[2] = true;
        print("Success! Room 102 is now booked for you.");
      }
    } else {
  ...
  //option 3 code here
    ...
    print("-------Thank you for using Hotel System. Goodbye!");
    isRunning = false;
